...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202410251212-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Friday, Oct 25, 2024 12:12 EDT
# @@File             :  install.sh
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
export APPNAME="opengist"
export VERSION="202410251212-git"
...
DOCKER_REGISTRY_REPO_NAME="opengist"
...
CONTAINER_WEB_SERVER_VHOSTS="$CONTAINER_HOSTNAME.$CONTAINER_DOMAINNAME,$CONTAINER_HOSTNAME.all"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set custom script - saves to /config/env/opengist.script.sh
